-- Table: dwh.d_tsettaxcommunity

-- DROP TABLE IF EXISTS dwh.d_tsettaxcommunity;

CREATE TABLE IF NOT EXISTS dwh.d_tsettaxcommunity
(
    tset_tax_com_key bigint NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    ...
    CONSTRAINT d_tset_tax_community_pkey PRIMARY KEY (tset_tax_com_key),
    CONSTRAINT d_tset_tax_community_ukey UNIQUE (tax_type, tax_community)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS dwh.d_tsettaxcommunity
    OWNER to proconnect;
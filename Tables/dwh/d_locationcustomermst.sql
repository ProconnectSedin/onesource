-- Table: dwh.d_locationcustomermst

-- DROP TABLE IF EXISTS dwh.d_locationcustomermst;

CREATE TABLE IF NOT EXISTS dwh.d_locationcustomermst
(
    locationcustomermst_key bigint NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    location_key bigint,
    tranou integer,
    ...
    customer_creation_date timestamp(3) without time zone,
    ...
    CONSTRAINT d_locationcustomer_mst_pkey PRIMARY KEY (locationcustomermst_key),
    CONSTRAINT d_locationcustomer_mst_unq UNIQUE (tranou, customercode, locationcode)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS dwh.d_locationcustomermst
    OWNER to proconnect;
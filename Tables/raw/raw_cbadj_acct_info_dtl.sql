-- Table: raw.raw_cbadj_acct_info_dtl

-- DROP TABLE IF EXISTS "raw".raw_cbadj_acct_info_dtl;

CREATE TABLE IF NOT EXISTS "raw".raw_cbadj_acct_info_dtl
(
    ...
    CONSTRAINT raw_cbadj_acct_info_dtl_pkey PRIMARY KEY (raw_id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS "raw".raw_cbadj_acct_info_dtl
    OWNER to proconnect;
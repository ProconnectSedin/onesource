-- Table: raw.raw_fcc_bfg_prd_close_status

-- DROP TABLE IF EXISTS "raw".raw_fcc_bfg_prd_close_status;

CREATE TABLE IF NOT EXISTS "raw".raw_fcc_bfg_prd_close_status
(
    ...
    CONSTRAINT raw_fcc_bfg_prd_close_status_pkey PRIMARY KEY (raw_id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS "raw".raw_fcc_bfg_prd_close_status
    OWNER to proconnect;
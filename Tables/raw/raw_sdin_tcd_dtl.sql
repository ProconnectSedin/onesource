-- Table: raw.raw_sdin_tcd_dtl

-- DROP TABLE IF EXISTS "raw".raw_sdin_tcd_dtl;

CREATE TABLE IF NOT EXISTS "raw".raw_sdin_tcd_dtl
(
    ...
    CONSTRAINT sdin_tcd_dtl_pkey PRIMARY KEY (raw_id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS "raw".raw_sdin_tcd_dtl
    OWNER to proconnect;
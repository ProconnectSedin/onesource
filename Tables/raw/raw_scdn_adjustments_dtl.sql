-- Table: raw.raw_scdn_adjustments_dtl

-- DROP TABLE IF EXISTS "raw".raw_scdn_adjustments_dtl;

CREATE TABLE IF NOT EXISTS "raw".raw_scdn_adjustments_dtl
(
    ...
    CONSTRAINT raw_scdn_adjustments_dtl_pky PRIMARY KEY (raw_id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS "raw".raw_scdn_adjustments_dtl
    OWNER to proconnect;
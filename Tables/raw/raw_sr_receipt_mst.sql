-- Table: raw.raw_sr_receipt_mst

-- DROP TABLE IF EXISTS "raw".raw_sr_receipt_mst;

CREATE TABLE IF NOT EXISTS "raw".raw_sr_receipt_mst
(
    ...
    CONSTRAINT sr_receipt_mst_pkey PRIMARY KEY (raw_id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS "raw".raw_sr_receipt_mst
    OWNER to proconnect;
-- Table: raw.raw_ard_customer_account_mst

-- DROP TABLE IF EXISTS "raw".raw_ard_customer_account_mst;

CREATE TABLE IF NOT EXISTS "raw".raw_ard_customer_account_mst
(
    ...
    CONSTRAINT raw_ard_customer_account_mst_pkey PRIMARY KEY (raw_id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS "raw".raw_ard_customer_account_mst
    OWNER to proconnect;
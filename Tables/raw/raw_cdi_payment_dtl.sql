-- Table: raw.raw_cdi_payment_dtl

-- DROP TABLE IF EXISTS "raw".raw_cdi_payment_dtl;

CREATE TABLE IF NOT EXISTS "raw".raw_cdi_payment_dtl
(
    ...
    CONSTRAINT raw_cdi_payment_dtl_pkey PRIMARY KEY (raw_id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS "raw".raw_cdi_payment_dtl
    OWNER to proconnect;
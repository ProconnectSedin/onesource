-- Table: raw.raw_factattrition

-- DROP TABLE IF EXISTS "raw".raw_factattrition;

CREATE TABLE IF NOT EXISTS "raw".raw_factattrition
(
    ou integer,
...
ALTER TABLE IF EXISTS "raw".raw_factattrition
    OWNER to proconnect;
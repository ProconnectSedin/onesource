-- Table: raw.raw_mac_element_account_mapping

-- DROP TABLE IF EXISTS "raw".raw_mac_element_account_mapping;

CREATE TABLE IF NOT EXISTS "raw".raw_mac_element_account_mapping
(
    ...
    CONSTRAINT mac_element_account_mapping_pkey PRIMARY KEY (raw_id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS "raw".raw_mac_element_account_mapping
    OWNER to proconnect;
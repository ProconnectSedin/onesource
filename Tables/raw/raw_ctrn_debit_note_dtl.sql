-- Table: raw.raw_ctrn_debit_note_dtl

-- DROP TABLE IF EXISTS "raw".raw_ctrn_debit_note_dtl;

CREATE TABLE IF NOT EXISTS "raw".raw_ctrn_debit_note_dtl
(
    ...
    CONSTRAINT raw_ctrn_debit_note_dtl_pkey PRIMARY KEY (raw_id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS "raw".raw_ctrn_debit_note_dtl
    OWNER to proconnect;
-- Table: raw.raw_ci_doc_item_dtl

-- DROP TABLE IF EXISTS "raw".raw_ci_doc_item_dtl;

CREATE TABLE IF NOT EXISTS "raw".raw_ci_doc_item_dtl
(
    ...
    CONSTRAINT raw_ci_doc_item_dtl_pkey PRIMARY KEY (raw_id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS "raw".raw_ci_doc_item_dtl
    OWNER to proconnect;
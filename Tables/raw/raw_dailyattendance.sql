-- Table: raw.raw_dailyattendance

-- DROP TABLE IF EXISTS "raw".raw_dailyattendance;

CREATE TABLE IF NOT EXISTS "raw".raw_dailyattendance
(
    ou integer,
...
ALTER TABLE IF EXISTS "raw".raw_dailyattendance
    OWNER to proconnect;
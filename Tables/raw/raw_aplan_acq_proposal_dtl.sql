-- Table: raw.raw_aplan_acq_proposal_dtl

-- DROP TABLE IF EXISTS "raw".raw_aplan_acq_proposal_dtl;

CREATE TABLE IF NOT EXISTS "raw".raw_aplan_acq_proposal_dtl
(
    ...
    CONSTRAINT raw_aplan_acq_proposal_dtl_pkey PRIMARY KEY (raw_id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS "raw".raw_aplan_acq_proposal_dtl
    OWNER to proconnect;
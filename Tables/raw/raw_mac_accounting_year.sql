-- Table: raw.raw_mac_accounting_year

-- DROP TABLE IF EXISTS "raw".raw_mac_accounting_year;

CREATE TABLE IF NOT EXISTS "raw".raw_mac_accounting_year
(
    ...
    CONSTRAINT mac_accounting_year_pkey PRIMARY KEY (raw_id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS "raw".raw_mac_accounting_year
    OWNER to proconnect;
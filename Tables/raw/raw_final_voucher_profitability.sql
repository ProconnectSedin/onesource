-- Table: raw.raw_final_voucher_profitability

-- DROP TABLE IF EXISTS "raw".raw_final_voucher_profitability;

CREATE TABLE IF NOT EXISTS "raw".raw_final_voucher_profitability
(
    ...
    CONSTRAINT final_voucher_profitability_pkey PRIMARY KEY (raw_id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS "raw".raw_final_voucher_profitability
    OWNER to proconnect;
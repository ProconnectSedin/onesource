-- Table: click.f_outboundheader

-- DROP TABLE IF EXISTS click.f_outboundheader;

CREATE TABLE IF NOT EXISTS click.f_outboundheader
(
    ...
    oub_orderqualifydatekey bigint,
    oub_orderqualifydate date,
    oub_cutofftime time without time zone,
    oub_openingtime time without time zone,
    CONSTRAINT f_outboundheader_pkey PRIMARY KEY (obh_hr_key),
    CONSTRAINT f_outboundheader_ukey UNIQUE (oub_ou, oub_loc_code, oub_outbound_ord)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS click.f_outboundheader
    OWNER to proconnect;
-- Index: f_outboundheader_idx

-- DROP INDEX IF EXISTS click.f_outboundheader_idx;

CREATE INDEX IF NOT EXISTS f_outboundheader_idx
    ON click.f_outboundheader USING btree
    (oub_ou ASC NULLS LAST, oub_loc_code COLLATE public.nocase ASC NULLS LAST, oub_order_type COLLATE public.nocase ASC NULLS LAST, oub_shipment_type COLLATE public.nocase ASC NULLS LAST)
    TABLESPACE pg_default;
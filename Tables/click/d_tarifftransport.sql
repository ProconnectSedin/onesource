...
(
    ...
    CONSTRAINT d_tarifftransport_pkey PRIMARY KEY (tf_tp_key),
    CONSTRAINT d_tarifftransport_ukey UNIQUE (tf_tp_id, tf_tp_ou)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS click.d_tarifftransport
    OWNER to proconnect;
-- Index: d_tarifftransport_idx

-- DROP INDEX IF EXISTS click.d_tarifftransport_idx;

CREATE INDEX IF NOT EXISTS d_tarifftransport_idx
    ON click.d_tarifftransport USING btree
    (tf_tp_id COLLATE public.nocase ASC NULLS LAST, tf_tp_ou ASC NULLS LAST)
    TABLESPACE pg_default;
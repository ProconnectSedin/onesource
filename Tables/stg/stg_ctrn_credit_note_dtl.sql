-- Table: stg.stg_ctrn_credit_note_dtl

-- DROP TABLE IF EXISTS stg.stg_ctrn_credit_note_dtl;

CREATE TABLE IF NOT EXISTS stg.stg_ctrn_credit_note_dtl
(
    ...
    CONSTRAINT ctrn_credit_note_dtl_pkey UNIQUE (ou_id, tcn_no)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS stg.stg_ctrn_credit_note_dtl
    OWNER to proconnect;
-- Index: stg_ctrn_credit_note_dtl_key_idx2

-- DROP INDEX IF EXISTS stg.stg_ctrn_credit_note_dtl_key_idx2;

CREATE INDEX IF NOT EXISTS stg_ctrn_credit_note_dtl_key_idx2
    ON stg.stg_ctrn_credit_note_dtl USING btree

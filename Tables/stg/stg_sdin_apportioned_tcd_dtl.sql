-- Table: stg.stg_sdin_apportioned_tcd_dtl

-- DROP TABLE IF EXISTS stg.stg_sdin_apportioned_tcd_dtl;

CREATE TABLE IF NOT EXISTS stg.stg_sdin_apportioned_tcd_dtl
(
    ...
    CONSTRAINT sdin_apportioned_tcd_dtl_pkey UNIQUE (tran_type, tran_ou, tran_no, line_no, item_tcd_code, item_tcd_var, tcd_version)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS stg.stg_sdin_apportioned_tcd_dtl
    OWNER to proconnect;
-- Index: stg_sdin_apportioned_tcd_dtl_key_idx2

-- DROP INDEX IF EXISTS stg.stg_sdin_apportioned_tcd_dtl_key_idx2;

CREATE INDEX IF NOT EXISTS stg_sdin_apportioned_tcd_dtl_key_idx2
    ON stg.stg_sdin_apportioned_tcd_dtl USING btree

-- Table: stg.stg_tset_tax_community

-- DROP TABLE IF EXISTS stg.stg_tset_tax_community;

CREATE TABLE IF NOT EXISTS stg.stg_tset_tax_community
(
...
ALTER TABLE IF EXISTS stg.stg_tset_tax_community
    OWNER to proconnect;
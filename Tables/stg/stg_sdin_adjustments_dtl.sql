-- Table: stg.stg_sdin_adjustments_dtl

-- DROP TABLE IF EXISTS stg.stg_sdin_adjustments_dtl;

CREATE TABLE IF NOT EXISTS stg.stg_sdin_adjustments_dtl
(
    ...
    CONSTRAINT sdin_adjustments_dtl_pkey PRIMARY KEY (tran_type, tran_ou, tran_no, ref_doc_type, ref_doc_no)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS stg.stg_sdin_adjustments_dtl
    OWNER to proconnect;
-- Index: stg_sdin_adjustments_dtl_idx

-- DROP INDEX IF EXISTS stg.stg_sdin_adjustments_dtl_idx;

CREATE INDEX IF NOT EXISTS stg_sdin_adjustments_dtl_idx
    ON stg.stg_sdin_adjustments_dtl USING btree

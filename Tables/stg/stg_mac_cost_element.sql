-- Table: stg.stg_mac_cost_element

-- DROP TABLE IF EXISTS stg.stg_mac_cost_element;

CREATE TABLE IF NOT EXISTS stg.stg_mac_cost_element
(
...
ALTER TABLE IF EXISTS stg.stg_mac_cost_element
    OWNER to proconnect;
-- Index: stg_mac_cost_element_key_idx2

-- DROP INDEX IF EXISTS stg.stg_mac_cost_element_key_idx2;

CREATE INDEX IF NOT EXISTS stg_mac_cost_element_key_idx2
    ON stg.stg_mac_cost_element USING btree

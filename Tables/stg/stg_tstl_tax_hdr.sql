-- Table: stg.stg_tstl_tax_hdr

-- DROP TABLE IF EXISTS stg.stg_tstl_tax_hdr;

CREATE TABLE IF NOT EXISTS stg.stg_tstl_tax_hdr
(
...
ALTER TABLE IF EXISTS stg.stg_tstl_tax_hdr
    OWNER to proconnect;
-- Index: stg_tstl_tax_hdr_idx

-- DROP INDEX IF EXISTS stg.stg_tstl_tax_hdr_idx;

CREATE INDEX IF NOT EXISTS stg_tstl_tax_hdr_idx
    ON stg.stg_tstl_tax_hdr USING btree

-- Table: stg.stg_scdn_payment_dtl

-- DROP TABLE IF EXISTS stg.stg_scdn_payment_dtl;

CREATE TABLE IF NOT EXISTS stg.stg_scdn_payment_dtl
(
    ...
    CONSTRAINT scdn_payment_dtl_pkey PRIMARY KEY (tran_type, tran_ou, tran_no, term_no)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS stg.stg_scdn_payment_dtl
    OWNER to proconnect;
-- Index: stg_scdn_payment_dtl_idx

-- DROP INDEX IF EXISTS stg.stg_scdn_payment_dtl_idx;

CREATE INDEX IF NOT EXISTS stg_scdn_payment_dtl_idx
    ON stg.stg_scdn_payment_dtl USING btree

-- Table: stg.stg_cust_addr_dtl

-- DROP TABLE IF EXISTS stg.stg_cust_addr_dtl;

CREATE TABLE IF NOT EXISTS stg.stg_cust_addr_dtl
(
    ...
    CONSTRAINT cust_addr_dtl_pk PRIMARY KEY (addr_lo, addr_cust_code, addr_lineno)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS stg.stg_cust_addr_dtl
    OWNER to proconnect;
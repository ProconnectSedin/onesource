-- Table: stg.stg_supp_spmn_suplmain

-- DROP TABLE IF EXISTS stg.stg_supp_spmn_suplmain;

CREATE TABLE IF NOT EXISTS stg.stg_supp_spmn_suplmain
(
    ...
    CONSTRAINT pk_supmain PRIMARY KEY (supp_spmn_loid, supp_spmn_supcode)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS stg.stg_supp_spmn_suplmain
    OWNER to proconnect;
-- Index: stg_supp_spmn_suplmain_key_idx2

-- DROP INDEX IF EXISTS stg.stg_supp_spmn_suplmain_key_idx2;

CREATE INDEX IF NOT EXISTS stg_supp_spmn_suplmain_key_idx2
    ON stg.stg_supp_spmn_suplmain USING btree

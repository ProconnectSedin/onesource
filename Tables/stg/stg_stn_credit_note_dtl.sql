-- Table: stg.stg_stn_credit_note_dtl

-- DROP TABLE IF EXISTS stg.stg_stn_credit_note_dtl;

CREATE TABLE IF NOT EXISTS stg.stg_stn_credit_note_dtl
(
    ...
    CONSTRAINT stn_credit_note_dtl_pkey PRIMARY KEY (ou_id, trns_credit_note, tran_type)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS stg.stg_stn_credit_note_dtl
    OWNER to proconnect;
-- Index: stg_stn_credit_note_dtl_idx

-- DROP INDEX IF EXISTS stg.stg_stn_credit_note_dtl_idx;

CREATE INDEX IF NOT EXISTS stg_stn_credit_note_dtl_idx
    ON stg.stg_stn_credit_note_dtl USING btree
    (ou_id ASC NULLS LAST, trns_credit_note COLLATE public.nocase ASC NULLS LAST, tran_type COLLATE public.nocase ASC NULLS LAST)
    TABLESPACE pg_default;
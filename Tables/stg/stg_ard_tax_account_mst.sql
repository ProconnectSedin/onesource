-- Table: stg.stg_ard_tax_account_mst

-- DROP TABLE IF EXISTS stg.stg_ard_tax_account_mst;

CREATE TABLE IF NOT EXISTS stg.stg_ard_tax_account_mst
(
    ...
    CONSTRAINT ard_tax_account_mst_pk PRIMARY KEY (company_code, tax_type, tax_community, tax_class, tax_category, tax_region, tax_accounttype, effective_from, sequence_no, tax_group, tax_code, account_code)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS stg.stg_ard_tax_account_mst
    OWNER to proconnect;
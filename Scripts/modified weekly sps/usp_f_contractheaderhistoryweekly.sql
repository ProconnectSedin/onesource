-- PROCEDURE: dwh.usp_f_contractheaderhistoryweekly(character varying, character varying, character varying, character varying)

-- DROP PROCEDURE IF EXISTS dwh.usp_f_contractheaderhistoryweekly(character varying, character varying, character varying, character varying);

CREATE OR REPLACE PROCEDURE dwh.usp_f_contractheaderhistoryweekly(
...
/*****************************************************************************************************************/
/* PROCEDURE		:	dwh.usp_f_contractheaderhistoryweekly														 				 */
/* DESCRIPTION		:	This sp is used to load f_contractheaderhistoryweekly table from stg_wms_contract_hdr_h        			 			 */
/*						Load Strategy: Insert/Update 															 */
/*						Sources: wms_contract_hdr_h_w					 		 									 */
/*****************************************************************************************************************/
/* DEVELOPMENT HISTORY																							 */
/*****************************************************************************************************************/
/* AUTHOR    		:	AKASH V																						 */
...
/* DESCRIPTION		:													  										 */
/*****************************************************************************************************************/
/* EXECUTION SAMPLE :CALL dwh.usp_f_contractheaderhistoryweekly('wms_contract_hdr_h_w','StgtoDW','f_asnheader
',0,0,0,0,NULL,NULL);*/
/*****************************************************************************************************************/
...
END;
$BODY$;
ALTER PROCEDURE dwh.usp_f_contractheaderhistoryweekly(character varying, character varying, character varying, character varying)
    OWNER TO proconnect;

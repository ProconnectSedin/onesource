CREATE OR REPLACE PROCEDURE click.usp_d_assetaccountmaster()
    LANGUAGE plpgsql
AS
$$
...
BEGIN
    ...
    SET d_asset_mst_key   = s.d_asset_mst_key,
    ...
    INSERT INTO click.d_assetaccountmaster(d_asset_mst_key, company_code, fb_id, asset_class, asset_usage,
                                           effective_from, sequence_no, timestamp, account_code, effective_to, resou_id,
                                           createdby, createddate, modifiedby, modifieddate, etlactiveind, etljobname,
                                           envsourcecd, datasourcecd, etlcreatedatetime)
    SELECT s.d_asset_mst_key,
           s.company_code,
           s.fb_id,
           s.asset_class,
           s.asset_usage,

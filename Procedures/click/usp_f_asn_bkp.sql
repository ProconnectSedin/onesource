-- PROCEDURE: click.usp_f_asn_bkp()

-- DROP PROCEDURE IF EXISTS click.usp_f_asn_bkp();

CREATE OR REPLACE PROCEDURE click.usp_f_asn_bkp(
	)
LANGUAGE 'plpgsql'
AS $BODY$
DECLARE 
...
END;
$BODY$;
ALTER PROCEDURE click.usp_f_asn_bkp()
    OWNER TO proconnect;

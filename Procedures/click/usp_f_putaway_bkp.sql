-- PROCEDURE: click.usp_f_putaway_bkp()

-- DROP PROCEDURE IF EXISTS click.usp_f_putaway_bkp();

CREATE OR REPLACE PROCEDURE click.usp_f_putaway_bkp(
	)
LANGUAGE 'plpgsql'
AS $BODY$
DECLARE 
...
END;
$BODY$;
ALTER PROCEDURE click.usp_f_putaway_bkp()
    OWNER TO proconnect;

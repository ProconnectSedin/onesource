-- PROCEDURE: click.usp_f_wmsoutboundsladetailday()

-- DROP PROCEDURE IF EXISTS click.usp_f_wmsoutboundsladetailday();

CREATE OR REPLACE PROCEDURE click.usp_f_wmsoutboundsladetailday(
	)
LANGUAGE 'plpgsql'
AS $BODY$
DECLARE 
...
END;
$BODY$;
ALTER PROCEDURE click.usp_f_wmsoutboundsladetailday()
    OWNER TO proconnect;

...
LEFT JOIN dwh.d_location L      
  ...
  --  AND t.inb_amendno = s.wms_inb_amendno     
	AND t.inb_amh_key  = oh.inb_hdr_key;
	truncate table dwh.F_InboundItemAmendDetail restart identity;
    ...
    SELECT
         ...
         oh.inb_hdr_key,COALESCE(c.itm_hdr_key,-1),COALESCE(l.loc_key,-1),

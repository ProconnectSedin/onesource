...
BEGIN
    ...
    (
         cust_Id,   client_Name,    service_Name,   service_Type,   client_Json,  
           status,     error_Massage,  key_Search1,    key_Search2,    key_Search3,  
    ...
    SELECT
        ...
        s.status,   s.error_Massage,   s.key_Search1,  s.key_Search2,  s.key_Search3, 

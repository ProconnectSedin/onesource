-- PROCEDURE: dwh.usp_f_trippodattachmentdetail(character varying, character varying, character varying, character varying)

-- DROP PROCEDURE IF EXISTS dwh.usp_f_trippodattachmentdetail(character varying, character varying, character varying, character varying);

CREATE OR REPLACE PROCEDURE dwh.usp_f_trippodattachmentdetail(
...
END;
$BODY$;
ALTER PROCEDURE dwh.usp_f_trippodattachmentdetail(character varying, character varying, character varying, character varying)
    OWNER TO proconnect;
